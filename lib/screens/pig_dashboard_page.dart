...
class PigDashboardPage extends StatefulWidget {
  final Function(Locale) onLocaleChange;
  final String userName;
  final String farmSizeWithUnit;

  const PigDashboardPage({
    super.key,
  ...
  @override
  State<PigDashboardPage> createState() => _PigDashboardPageState();
}

class _PigDashboardPageState extends State<PigDashboardPage> {
